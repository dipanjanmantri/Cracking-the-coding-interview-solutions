...
public class Linkedlist_addition_v1 {
	...
	public static void main(String[] args)
	{
		...
		LinkedList node3=f3(a,d);
		
		LinkedList node4=f4(a,d);
	...
	private static LinkedList f4(LinkedList a, LinkedList d) {
		
		return null;
	}

	private static LinkedList f3(LinkedList a, LinkedList d) {
		...
		int digit2=a.link.data+d.link.data+carry;
		if(digit2>=10)
		{
			carry=digit2%10;
			digit2/=10;
		}
		int digit3=a.link.link.data+d.link.link.data+carry;
		
		LinkedList a1=new LinkedList(digit3,null);
		a1.link=new LinkedList(digit2,null);
		a1.link.link=new LinkedList(digit1,null);
		return a1;
	}
